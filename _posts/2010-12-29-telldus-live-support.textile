...
Starting from v1.4.1, you should now have the option to choose service on the Preference page. You can only communicate using one service at the time. Obviously, _Groups_ created will only be associated with the service where it was created.
